...
% minlon=deg2utm(str2num(osm.bounds.minlon));
% maxlon=deg2utm(str2num(osm.bounds.maxlon));

% plot([minlat minlat],[minlon maxlon]);
% plot([minlat maxlat],[minlon minlon]);
% plot([minlat maxlat],[maxlon maxlon]);
% plot([maxlat maxlat],[minlon maxlon]);
